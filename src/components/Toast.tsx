...
// A listener may receive either a full toast or a removal signal { id, remove }.
type ToastEvent = Toast | { id: number; remove: true }
type ToastListener = (toast: ToastEvent) => void

let toastId = 0
const listeners = new Set<ToastListener>()

export function showToast(message: string, type: ToastType = 'success', duration = 4000): number {
  const id = ++toastId
